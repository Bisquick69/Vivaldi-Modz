(function () {
    ...
    function createContextMenuOption () {
        chrome.contextMenus.create({
            'id': 'dialog-tab-link',
            'title': '[Dialog Tab] Open Linky in Popup thing',
            'contexts': ['link']
        });
        chrome.contextMenus.create({
            'id': 'search-dialog-tab',
            'title': '[Dialog Tab] Search for "%s" in Popup thingy',
            'contexts': ['selection']
        });
        /**
        * chrome.contextMenus.create({
        *    'id': 'select-search-dialog-tab',
        *    'title': '[Dialog Tab] Search in Popup thingy with',
        *    'contexts': ['selection']
        *});
        */
   ...
   */
    ...
    */
    ...
    function dialogTab (linkUrl) {
        ...
        divOptionContainer.style.color = "var(--colorAccentBg)";
        ...
        progressBar.style.backgroundColor = "var(--colorAccentBgDark)"; // WAS #0080ff
